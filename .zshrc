...
DOTNET_HOME=/usr/local/dotnet
JAVA_HOME=/usr/local/jdk
NODE_HOME=/usr/local/node
export PATH=$JAVA_HOME/bin:$NODE_HOME/bin:/usr/local/nodejs/bin:~/.local/bin:$ZSH_HOME/bin:$POSTGRESQL_HOME/bin:$GRADLE_HOME/bin:$GO_HOME/bin:$TOMCAT_HOME/bin:$MVN_HOME/bin:$OPENRESTY_HOME/luajit/bin:$OPENRESTY_HOME/nginx/sbin:$MYSQL_HOME/bin:$PHP_HOME/bin:$PYTHON3_HOME/bin:$TFS_HOME:/usr/local/bin:$DOTNET_HOME:/usr/local/nvim/bin:/usr/local/dotnet:~/.dotnet/tools:$PATH
